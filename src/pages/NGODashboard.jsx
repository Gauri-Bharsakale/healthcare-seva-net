...
const NGODashboard = () => {
  ...
  // Mock data for doctors and patients (unchanged)
  const mockDoctors = [
    { id: 1, name: "Dr. Rajesh Kumar", specialization: "Cardiologist", location: "Mumbai" },
    { id: 2, name: "Dr. Priya Sharma", specialization: "Pediatrician", location: "Delhi" },
    { id: 3, name: "Dr. Amit Patel", specialization: "General Physician", location: "Pune" }
  ...
  // Fetch NGO data based on logged-in user
  useEffect(() => {
      ...
      try {
        ...
        if (userSnap.exists()) {
          ...
          if (data.role === "NGO") {
            ...
            console.warn("This user is not registered as an NGO.");
          }
        } else {
              ...
              <CardHeader className="flex flex-row items-start justify-between">
                <div>
                  <CardTitle className="text-2xl">
                    {ngoData ? ngoData.ngoName : "Loading..."}
                  </CardTitle>
                  <CardDescription className="text-lg mt-1">
                    {ngoData ? ngoData.areaOfWork : "Fetching data..."}
                  </CardDescription>
                </div>
                <div className="flex gap-2">
                  <Button className="rounded-full">
                ...
                {ngoData ? (
                  <>
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">Area of Work</p>
                        <p className="font-medium">{ngoData.areaOfWork}</p>
                      </div>
                      <div>
                        <p className="text-sm text-muted-foreground">Contact Person</p>
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">Registration No.</p>
                        <p className="font-medium">{ngoData.registrationNo}</p>
                      </div>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground mb-2">Description</p>
                  ...
                  <p className="text-muted-foreground text-center">Loading NGO details...</p>
                )}
              </CardContent>
            </Card>
          </TabsContent>
