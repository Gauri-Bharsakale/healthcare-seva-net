        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {categoryConfig.map((config, index) => {
            ...
            return (
              <Card
                key={index}
                className="hover:shadow-soft transition-smooth border-border/50 overflow-hidden group"
              >
                <CardHeader>
                  <div
                    className={`w-16 h-16 rounded-2xl ${config.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-smooth`}
                  >
